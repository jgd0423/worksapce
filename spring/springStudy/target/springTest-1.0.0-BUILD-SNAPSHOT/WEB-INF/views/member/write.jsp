	...
	<table border="1" align="center" width="80%">
		...
		<tr>
			...
			<td>
				...
				<button type="button" id="id_check">아이디중복체크</button>
				<button type="button" id="id_check_win_open">아이디중복체크(새창)</button>
				<br>
		...
		<tr>
			<td>성별</td>
			<td>
				<input type="radio" name="genderRadio" value="M" checked onclick="chooseGender('M')" /> 남자
				&nbsp;&nbsp;&nbsp;
				<input type="radio" name="genderRadio" value="F" onclick="chooseGender('F')" /> 여자
				<br>
...
function id_check_win_open() {
	window.open("${path}/member/id_check_win.do", 
			"id_check", 
